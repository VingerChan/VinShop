...
# 4.Celery自动检测指定包的任务
app.autodiscover_tasks(['celery_tasks.sms.tasks','celery_tasks.email.tasks','celery_tasks.search.tasks','celery_tasks.order.tasks','celery_tasks.comments.tasks','celery_tasks.static_index.tasks','celery_tasks.static_detail.tasks'])