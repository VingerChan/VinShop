...
class OrderInfo(BaseModel):
    ...
    pay_method = models.SmallIntegerField(default=1,choices=PAY_METHODS_CHOICES,verbose_name='支付方式')
    status = models.SmallIntegerField(default=1,choices=STATUS_CHOICES,verbose_name='订单状态')
    class Meta:
